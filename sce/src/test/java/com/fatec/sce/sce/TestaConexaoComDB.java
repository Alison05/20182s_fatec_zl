...
*/
	...
	public void quandoConectaComSenhaInvalida_SQLException() {
		...
		String usuario = "root";
		String senha = "senharo"; //senha errada
	...
	/**
	* Objetivo - verificar o comportamento do sistema na conexao ao DB com usuario de acesso invalido
	* Pré-condição - o usuario cadastrada é "root"
	*/
		@Test
		public void quandoConectaComUsuarioInvalido_SQLException() {
			...
			try {
				...
				// verificacao
				System.out.println(e.getMessage());
				assertEquals(e.getMessage(),"java.sql.SQLException: Access denied for user 'roo'@'localhost' (using password: YES)");
			}
		}
}